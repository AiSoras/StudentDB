...
void ShowAllGroups() //Ïîêàçûâàåò íîìåðà âñåõ ñîçäàííûõ ãðóïï, ãäå â ñêîáêàõ óêàçàíî êîëè÷åñòâî ñòóäåíòîâ â ãðóïïå. Òàêæå óêàçàíî îáùåå ÷èñëî ñòóäåíòîâ â ïîòîêå
{
	if (start)
	{
		int all = 0;
...
double AverageGrade() //Âû÷èñëÿåò ñðåäíåå àðèôìåòè÷åñêîå ïîòîêà
{
	double aver = 0;
	if (start)
	{
...
void ExcellentPupil() //Âûâîäèò îòëè÷íèêîâ âñåãî ïîòîêà
{
	if (start)
	{
		if (!start->stud && start->next == NULL)
